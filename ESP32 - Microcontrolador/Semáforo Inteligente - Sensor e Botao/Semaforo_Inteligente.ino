...
// O PEDESTRE PODE ACIONAR COM O BOTÃO OU SENSOR DE MOVIMENTO (PENSADO PARA PCDs, IDOSOS ETC.)
// NA APLICAÇÃO É MISTER AS DEVIDAS ADAPTAÇÕES SOBRE O POSICIONAMENTO DO BOTÃO E SENSOR.
